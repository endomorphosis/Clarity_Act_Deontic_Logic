...
axiom REG_001_register_with_the_cftc : Obligatory Agent.DigitalCommodityExchange (True)

-- The digital commodity brokers is obligated to register with the cftc.
axiom REG_002_register_with_the_cftc : Obligatory Agent.DigitalCommodityBroker (True)

-- The digital commodity dealers is obligated to register with the cftc.
axiom REG_003_register_with_the_cftc : Obligatory Agent.DigitalCommodityDealer (True)

-- The issuers is obligated to disclose information about blockchain system maturity.
axiom REG_004_disclose_information_about_blockchain_system_matur : Obligatory Agent.Issuer (True)

-- The issuers is obligated to disclose financial condition.
axiom REG_005_disclose_financial_condition : Obligatory Agent.Issuer (True)
...
axiom TRD_001_implement_trade_monitoring : Obligatory Agent.DigitalCommodityExchange (True)

-- The exchanges is obligated to maintain recordkeeping systems.
axiom TRD_002_maintain_recordkeeping_systems : Obligatory Agent.DigitalCommodityExchange (True)

-- The exchanges is forbidden from commingle customer assets.
axiom TRD_003_commingle_customer_assets : Forbidden Agent.DigitalCommodityExchange (True)

-- The brokers is obligated to implement risk management.
axiom TRD_004_implement_risk_management : Obligatory Agent.DigitalCommodityBroker (True)
